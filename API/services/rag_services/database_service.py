...
class DatabaseService:
    ...
    def _validate_sql(self, query: str) -> str | None:
        ...
        if not (normalized.startswith("SELECT") or normalized.startswith("WITH")):
            return "Only SELECT is permitted."
    ...
    def execute_query(self, query: str) -> dict:
        ...
        if error:
            ...
            return {"error": "I couldn't process this query safely. Could you please clarify or rephrase?"}
        ...
        try:
            ...
            return {"error": "I encountered an issue processing that request. Could you please clarify?"}
        except Exception as e:
            logger.error("DB error: %s", e)
            return {"error": "An unexpected issue occurred. Could you please clarify your query?"}
